...
describe('Gantt transformProps', () => {
  ...
  test('should apply x-axis bounds even when zoomable is false', () => {
  ...
  test('should keep full axis range while narrowing initial dataZoom window', () => {
  ...
  test('should fallback to month when x-axis date unit is invalid', () => {
    ...
    const fallbackProps = transformProps(
      fallbackChartProps as EchartsGanttChartProps,
    );
